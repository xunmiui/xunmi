;(function($){
  ...
  var lightBox = function(setting){
    ...
    this.obj.on('click',  function(event) {
      ...
      //璁剧疆榛樿姣忔鐐瑰嚮鎻掑叆閬僵灞備笌鍥剧墖灞傜殑DOM缁撴瀯

      self.defaultDOM();



      //鐐瑰嚮褰撳墠瀵硅薄鑾峰彇鍒版墍鍦ㄧ殑闆嗗悎

      self.getImageGroup();



      //锛堢偣鍑汇€佸乏鍙冲垏鎹級璁剧疆寮瑰嚭鍥惧眰鐨勬晥鏋滃強鍥剧墖鐨勮浆鎹�
